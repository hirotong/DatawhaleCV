...
class VGGBase(nn.Module):
    ...
    def load_pretrained_layers(self):
        ...
        for i, param in enumerate(param_names[:-4]):
            ...
            state_dict['conv6.weight'] = decimate(conv_fc6_weight, m=[4, None, 3, 3])  # (1024, 512, 7, 7)
...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        # Auxiliary/additional convolutions on the top of the VGG base
...
class PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv4_3_feats, conv7_feats, conv8_2_feats, conv9_2_feats, conv10_2_feats, conv11_2_feats):
        ...
        l_conv7 = l_conv7.view(batch_size, -1, 4)  # (N, 2661, 4)
...
class SSD300(nn.Module):
    ...
    def detect_objects(self, predicted_locs, predicted_scores, min_score, max_overlap, top_k):
        """
        Desipher the 8732 locations and class scores (output of the SSD300) to detect objects.
